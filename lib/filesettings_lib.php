 ...
 * @return bool
 */
function theme_walrus_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    static $theme;
    if (empty($theme)) {
        $theme = theme_config::load('walrus');
    }
     ...
     */
function theme_walrus_get_setting($setting, $format = false) {
    global $CFG;
