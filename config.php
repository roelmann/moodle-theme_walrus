...
$THEME->scss = function($theme) {
    return theme_walrus_get_main_scss_content($theme);
};
...
$THEME->csstreepostprocessor = 'theme_walrus_css_tree_post_processor';
$THEME->prescsscallback = 'theme_walrus_get_pre_scss';
$THEME->extrascsscallback = 'theme_walrus_get_extra_scss';
